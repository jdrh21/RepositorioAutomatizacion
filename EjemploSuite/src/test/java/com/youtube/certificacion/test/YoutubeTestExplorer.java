...
public class YoutubeTestExplorer {
	...
	public void setUp() throws Exception {
		try {
			x.OpenBrowser("http://www.youtube.com","Explorer");		//Se usa metodo OpenBrowser de la clase YoutubePOM para abrir navegador indicado
			}catch(Exception e) {
