...
public class YoutubeTestFirefox {
	...
	public void setUp() throws Exception {
		try {
			x.OpenBrowser("http://www.youtube.com","Firefox");	//Se usa metodo OpenBrowser de la clase YoutubePOM para abrir navegador indicado
			}catch(Exception e) {
