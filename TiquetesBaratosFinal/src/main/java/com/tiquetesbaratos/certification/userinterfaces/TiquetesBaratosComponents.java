...
public class TiquetesBaratosComponents {
	...
	public static final Target ALERTA = Target.the("Alerta de notificaciones").located(By.id("onesignal-popover-container"));
	public static final Target CANCELAR_ALERTA = Target.the("cancelar Alerta de notificaciones").located(By.id("onesignal-popover-cancel-button"));
	...
	public static final Target ORIGEN_FIELD = Target.the("Campo origen de vuelo").located(By.name("origen"));
	public static final Target ORIGEN = Target.the("Elemento de la lista origen de vuelo").located(By.linkText("Medellin - Colombia(MDE)"));
	public static final Target DESTINO_FIELD = Target.the("Campo destino de vuelo").located(By.name("destino"));
	public static final Target DESTINO = Target.the("Elemento de la lista destino de vuelo").located(By.linkText("Bogota - Colombia (BOG)"));
